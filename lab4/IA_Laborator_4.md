# Inteligenta Artificiala, laborator nr.4.
...
4 ?- append_reverse([1, 2, 3], [4, 5, 6], X).                           
X = [3, 2, 1, 4, 5, 6] ;    
false.                                                            
                                                                  
5 ?- odd_to_even([1, 2, 3, 4, 5], R).      
R = [2, 1, 4, 3, 5] ;                                             
false.                                                            
                                                                  
6 ?- remove_all_but_last_repetitions([1, 2, 3, 4, 4, 4, 2, 2, 1], R).
R = [3, 4, 2, 1] ;                                                
false.                                                            
                                                                  
7 ?- occurs_twice(1, [1, 1]).   
true ;                                                            
false.                                                            
                                                                  
8 ?- occurs_twice(1, [1, 2]).      
false.                                                            
                                                                  
9 ?- occurs_twice(1, [1, 1, 1]).
false.   
                                     
11 ?- skip([1, 2, 3, 4, 5], 4, R).
R = [5] ;

6 ?- remove_all_but_last_repetitions([1, 2, 3, 4, 4, 4, 2, 2
R = [3, 4, 2, 1] ;                                          
false.                                                      
...
12 ?- prefix([1, 2, 3], [1, 2, 3, 4]).                      
true.                                                       
                                                            
13 ?- prefix([1, 2, 3], [0, 1, 2, 3, 4]).                   
false.                                                      
                                                            
14 ?- occurs_once(2, [2, 1, 1]).                            
true ;                                                      
false.                                                      
                                                            
15 ?- occurs_once(2, [2, 1, 1, 2]).                         
false.                                                  
                                                            
17 ?- add_last_two([1, 2, 3, 4], R).                        
R = 4 ;                                                     
false.                                                      
                                                            
18 ?- add_last_two([1, 2, 3, 4, 5], R).                     
R = 9 ;                                                     
false.                                                      
                                                            
19 ?- reconsult('lab5/main.pl').                            
true.                                                       
...
22 ?- add_last_two([1, 2], R).                                    
R = 3 ;                                                     
false.                                                      
                                                            
23 ?- add_last_two([1, 2, 3], R).                           
R = 5.                                                      
                                                            
24 ?- add_last_two([1, 2, 3, 4], R).                        
R = 4 ;                                                     
false.                                                      
 
1 ?- remove_element_odd(1, [1, 2, 1, 1, 2], R).
R = [2, 1, 2] ;
false.
```
...
Insusi cod deja este comentat, deci nu vad necesitatea.